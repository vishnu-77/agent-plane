...
0.4 that decision opens an **approval request** the runtime tracks for you.
...
- Console → **Live** → **Pending Approvals**: approve or reject with an
  optional note. The console sends the decision with the admin token you
  connected with.
