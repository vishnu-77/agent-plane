...
class AgentPlaneAdmin:
    ...
    def issue_lease(self, *, id: str, subject: str, task: str, resources: list[str],
                    actions: list[str], protected_resources: list[str] | None = None,
        ...
        body = {
            "id": id, "subject": subject, "task": task, "resources": resources, "actions": actions,
    ...
    def issue_from_template(self, template: str, *, subject: str, task: str,
                            variables: dict[str, str] | None = None, id: str | None = None) -> Lease:
